...
class ExcelReporter {
    constructor() {
        ...
        this.workbook.creator = 'Web Automation Framework';
        this.filePath = path.join(process.cwd(), 'excel', 'Selenium_E2E_Report.xlsx');
    ...
    initSheets() {
        ...
        this.summarySheet.columns = [
            ...
            { header: 'Browser', key: 'browser', width: 25 },
    ...
    async generateReport() {
        try {
            ...
            console.log(`Excel report generated successfully at: ${this.filePath}`);
        } catch (error) {
